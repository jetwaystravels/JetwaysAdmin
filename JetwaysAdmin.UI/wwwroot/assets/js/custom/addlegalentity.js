...
function addOfficeUSer(evt) {
    ...
    //var fitype = document.getElementById('financialType');
    //if (fitype && fitype.value.trim() !== '') {
    //    validateCorpCode(fitype);
    //    if (fitype.classList.contains('is-invalid')) return stopAt(fitype);
    //}
    //var gsttax = document.getElementById('gsttaxtype');
    //if (gsttax && gsttax.value.trim() !== '') {
    //    validateCorpCode(gsttax);
    //    if (gsttax.classList.contains('is-invalid')) return stopAt(gsttax);
    //}
    //var fn = document.getElementById('fName');
    //if (fn) {
    //    nameValidate(fn);
